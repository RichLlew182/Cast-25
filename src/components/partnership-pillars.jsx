...
export default function PartnerShipPillars({ scrollTo, refs }) {
  ...
  return (
    <>
      ...
      <section ref={refs.partnershipPillars} id="partnership-pillars" className="bg-licorice text-white">
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-12">
            ...
            <div className="box flex flex-col p-6 gap-6 border-solid border-2 border-white lg:w-1/3">
              <h3 className="text-2xl md:text-3xl xl:text-4xl ">
                <span>Build </span><span className="text-tomato inline"> + </span><span> Empower</span>
              </h3>
            ...
            <div className="box flex flex-col p-6 gap-6 border-solid border-2 border-white lg:w-1/3">
              <h3 className="text-2xl md:text-3xl xl:text-4xl">
                <span>Design </span><span className="text-tomato inline"> + </span><span> Enable</span>
              </h3>
            ...
            <div className="box flex flex-col p-6 gap-6 border-solid border-2 border-white lg:w-1/3">
              <h3 className="text-2xl md:text-3xl xl:text-4xl ">
                <span>Refine </span><span className="text-tomato inline"> + </span><span> Enhance</span>
              </h3>
