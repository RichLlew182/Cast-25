        ...
        <div ref={container} className="container mx-auto flex  flex-col justify-center items-start py-12 md:py-20 xl:py-36 gap-12  px-6">
          ...
          <div className=" flex flex-col lg:flex-row gap-4 md:gap-12">
            <div className="box flex flex-col px-0  gap-4 md:gap-6 w-full lg:w-1/2">
              ...
              <a href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollTo(refs.footer) }} className="hidden box fade text-xl sm:text-2xl lg:flex gap-2 font-syne font-bold text-tomato hover:text-orange">
            ...
            <div className="flex flex-col p-0 w-full lg:w-1/2">
              <ul ref={listRef1} id="projectManagementList" className="active flex flex-col gap-4 md:gap-6">
                ...
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">Localisation</li>
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">Digital marketing activity</li>
              ...
              <ul ref={listRef2} id="creativeProductionList" className="flex flex-col gap-4 md:gap-6">
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">Print (press, POS and OOH)</li>
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">Social media (content production and campaign activity - incl. influencers)</li>
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">PR and events</li>
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">Audio production</li>
                <li className="box text-2xl sm:text-3xl xl:text-4xl font-syne font-semibold">Video production</li>
              </ul>
