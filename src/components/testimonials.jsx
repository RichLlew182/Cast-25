...
export default function Testimonials({ refs }) {
  ...
  return (
    <section ref={refs.testimonials} className="bg-snow cursor-auto" id="testimonials">
      ...
      <div ref={container} className="container mx-auto flex  flex-col justify-center items-start gap-6  md:gap-14 py-12 md:py-14 xl:py-24  px-6">

        <h2 className="box fade text-4xl sm:text-5xl ">Testimonials</h2>

        <Flowbite theme={{ theme: CustomTheme }}>
          <Carousel slideInterval={5000} indicators={false} className="box carousel h-auto">

            <div className="slide flex flex-col h-auto items-start justify-start gap-6 px-10 sm:px-16  xl:px-32 relative">
              <blockquote className="testimonial-text text-xl sm:text-2xl md:text-3xl lg:text-2xl font-syne font-semibold">
