  ...
  return (
    <section ref={refs.testimonials} className="bg-snow cursor-auto" id="testimonials">
      ...
      <div className="container mx-auto flex  flex-col justify-center items-start gap-6  md:gap-14 py-20 xl:py-36  px-6">
        ...
        <h2 className="box fade text-4xl sm:text-5xl xl:text-6xl dark:text-white">Testimonials</h2>

        <Flowbite theme={{ theme: CustomTheme }}>
          <Carousel slideInterval={5000} indicators={false} className="h-auto">

            <div className="flex flex-col h-auto items-start justify-start gap-6 px-10 sm:px-16 md:px-20 xl:px-40 relative">
