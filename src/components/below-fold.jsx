      ...
      <section ref={refs.workWithUs} id="working-with-us" className="bg-snow">
        <div ref={container} className="container mx-auto flex flex-col justify-center items-start  gap-12 py-12 md:py-14 xl:py-24  px-6">
          ...
          <div className=" flex flex-col md:flex-row gap-6 md:gap-12">
            ...
            <div className="box flex flex-col bg-white p-12 lg:p-14 gap-6">
              <img src="/images/client-logos/RCSE.png" height="106" width="250" alt="Royal College of Surgeons of England Logo" />
            ...
            <div className="box flex flex-col bg-white  p-12 lg:p-14 gap-6">
              <img src="/images/client-logos/discovery-channel.png" height="106" width="250" alt="Discovery Channel Logo" />
