...
export default function AboveFold({scrollToFooter}) {
    ...
    return (
      ...
      <main ref={container} className="container mx-auto flex  flex-col justify-center items-start gap-6 py-48 md:py-72 px-6">
        <h1 className="fade text-5xl lg:text-7xl dark:text-white">Dynamic and versatile project delivery consultancy</h1>
