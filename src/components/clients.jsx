  ...
  return (
    <>
      ...
      <section ref={refs.clients} id="clients" className="bg-tomato">
        <div ref={container} className="clients-container container mx-auto flex  flex-col justify-center items-start  gap-16 py-12 md:py-14 xl:py-24 md:gap-24 px-6">
          <h2 className="box fade text-4xl sm:text-5xl ">Who we've worked with</h2>
