...
export default function WorkWithUs({ refs }) {
  ...
  return (
    <>
      ...
      <section ref={refs.workWithUs} id="working-with-us" className="bg-white">
        <div ref={container} className="container mx-auto flex flex-col justify-center items-start gap-6 md:gap-12 py-12 md:py-14 xl:py-24  px-6">
          ...
          <div className=" flex flex-col md:flex-row gap-6 md:gap-12">
            ...
            <div className="box flex flex-col bg-snow p-10 lg:p-14 gap-6">
