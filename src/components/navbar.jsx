      ...
      <header className="absolute w-full bg-tomato z-10 ">
        <Navbar fluid rounded className="container py-12 px-6 sm:px-6 mx-auto bg-transparent">
          ...
          <Navbar.Collapse className="container absolute xl:relative xl:left-0 xl:right-0 px-6 xl:px-0 xl:my-0 h-screen xl:h-auto xl:me-0 font-syne font-medium">
            <Navbar.Link href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollTo(refs.whatWeDo) }} className="font-bold xl:font-medium px-0 md:py-2 xl:py-0 flex gap-2 text-2xl sm:text-4xl xl:text-base text-licorice md:hover:text-white hover:bg-transparent border-none">What we do</Navbar.Link>
            ...
            <Navbar.Link href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollTo(refs.clients) }} className="font-bold xl:font-medium px-0 md:py-2 xl:py-0 flex gap-2 text-2xl sm:text-4xl xl:text-base text-licorice md:hover:text-white hover:bg-transparent border-none">Who we've worked with</Navbar.Link>
