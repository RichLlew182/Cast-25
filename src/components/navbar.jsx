  ...
  return (
    ...
    <Navbar  fluid rounded className="container py-12 px-6 sm:px-6 mx-auto bg-transparent">
      ...
      <Navbar.Collapse className="xl:my-0 h-screen xl:h-auto font-syne font-medium">
        ...
        <Navbar.Link href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollTo(refs.testimonials) }} className="font-bold xl:font-medium px-0 md:py-2 xl:py-0 flex gap-2 text-4xl xl:text-xl text-licorice md:hover:text-white hover:bg-transparent border-none">Testimonials</Navbar.Link>
       <Navbar.Link href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollTo(refs.footer) }} className="font-bold xl:font-medium px-0 md:py-2 xl:py-0 flex gap-2 text-4xl xl:text-xl text-licorice md:hover:text-white hover:bg-transparent border-none">Start your project<FontAwesomeIcon icon={faCircleArrowUp} /></Navbar.Link>
      </Navbar.Collapse>
      </Navbar>
      </header>
      </Flowbite>
