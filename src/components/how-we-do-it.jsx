        ...
        <div ref={container} className="container mx-auto flex  flex-col justify-center items-start  gap-12 py-20 xl:py-36 px-6">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl dark:text-white">How we do it</h2>
            ...
            <div id="scroller"className="flex flex-col">
              ...
              <div id="step1" className="steps flex flex-col bg-white  p-12 md:p-20 gap-6">
              <h3 className=" text-3xl sm:text-4xl xl:text-5xl dark:text-white">Responding to your brief</h3>
              ...
              <div id="step2" className="steps flex flex-col bg-white  p-12 md:p-20 gap-6">
              <h3 className=" text-3xl sm:text-4xl xl:text-5xl dark:text-white">Setting a strong platform</h3>
              ...
              <div id="step3" className="steps flex flex-col bg-white  p-12 md:p-20 gap-6">
              <h3 className=" text-3xl sm:text-4xl xl:text-5xl dark:text-white">Choosing the right methodology</h3>
              ...
              <div id="step4" className="steps flex flex-col bg-white  p-12 md:p-20 gap-6">
              <h3 className=" text-3xl sm:text-4xl xl:text-5xl dark:text-white">Preparedness for problems</h3>
              ...
              <h3 className=" text-3xl sm:text-4xl xl:text-5xl dark:text-white">Project end and ongoing support</h3>
